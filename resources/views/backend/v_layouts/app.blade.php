...
<html dir="ltr" lang="en">
  ...
  <title>Toko Online</title>
    ...
    <link
      rel="stylesheet"
      type="text/css"
      href="{{ asset('backend/matirx-admim/assets/extra-libs/multicheck/multicheck.css') }} "
    />
    <link
      href="{{ asset('backend/matirx-admim/assets/libs/datatables.net-bs4/css/dataTables.bootstrap4.css') }} "
      rel="stylesheet"
    />
    <link href="{{ asset('backend/matrix-admin/dist/css/style.min.css') }} " 
        rel="stylesheet" />
    ...
    >
      ...
      <div class="page-wrapper">
        ...
        <footer class="footer text-center">
          Web Progamming 2, Studi Kasus Toko Online
          <a href="https://www.wrappixel.com">Arnanda</a>.
        </footer>
        <!-- ============================================================== -->
        <!-- End footer -->
        <!-- ============================================================== -->
